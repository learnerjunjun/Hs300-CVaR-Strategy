...
while end_date <= 284:
    ...
    for i_month_1 in period_test:
        ...
        portfolio_return_cvar_coef = np.dot(portfolio_weights_cvar_coef.T, y_curr_month_return_corr)
        portfolio_return_cvar_ic = np.dot(portfolio_weights_cvar_ic.T, y_curr_month_return_corr)
