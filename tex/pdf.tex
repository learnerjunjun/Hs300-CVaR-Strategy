...
\begin{frame}{策略收益表现-Coef}
	\begin{itemize}
		\item 10年期收益及累计收益； 总体没有稳定明显地跑赢指数； 
		\item CVaR策略总体优于MV策略
	\end{itemize}
	\begin{figure}
		\centering
		\includegraphics[width=1\linewidth]{pic/Coef}
...
\begin{frame}{策略回撤-Coef}
	\begin{itemize}
		\item 两种策略最大回撤在 $30\%-40\%$，总体上回撤幅度低于指数
	\end{itemize}
	\begin{figure}
		\centering
...
\begin{frame}{策略收益表现-IC}
	...
	\begin{figure}
		\centering
		\includegraphics[width=1\linewidth]{pic/IC}
		\caption{Return and Compound Value}
		\label{fig:ic}
	\end{figure}
\end{frame}
...
\begin{frame}{策略收益表现-Corr}
	...
	\begin{figure}
		\centering
		\includegraphics[width=1\linewidth]{pic/Corr}
		\caption{Return and Compound Value}
		\label{fig:corr}
	\end{figure}
\end{frame}
...
\begin{frame}{策略对比评价}
	...
	\begin{table}[htbp]
		...
		\begin{tabular}{|c|c|c|c|c|c|}
			\toprule
			\textbf{Strategy} & \textbf{最大回撤} & \textbf{夏普比率} & \textbf{信息比率} & \textbf{年化收益率} & \textbf{收益回撤比} \\
			\midrule
			Coef  & 0.398 & 0.648 & -0.767 & 1.877\% & 4.720\% \\
			\midrule
			Cvar\_coef & 0.321 & 1.377 & -0.428 & 4.117\% & 12.844\% \\
			\midrule
			Ic    & 0.364 & 1.497 & -0.403 & 4.354\% & 11.961\% \\
			\midrule
			Cvar\_ic & 0.520 & 1.644 & -0.160 & 5.812\% & 11.179\% \\
			\midrule
			Corr  & 0.197 & 3.151 & 0.486 & 9.886\% & 50.094\% \\
			\midrule
			Cvar\_corr & 0.156 & 2.907 & 0.919 & 13.101\% & 84.249\% \\
			\midrule
			hs300 & 0.406 & 1.336 & 0.000 & 6.845\% & 16.877\% \\
			\bottomrule
		\end{tabular}%
		}
